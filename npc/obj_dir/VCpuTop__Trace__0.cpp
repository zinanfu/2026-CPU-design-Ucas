...
void VCpuTop___024root__trace_chg_0_sub_0(VCpuTop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[1U] 
        ...
        bufp->chgIData(oldp+3,(vlSelfRef.CpuTop__DOT__casez_tmp_3),32);
        bufp->chgSData(oldp+4,(vlSelfRef.CpuTop__DOT__byte_1),16);
        bufp->chgIData(oldp+5,(vlSelfRef.CpuTop__DOT__wb_data),32);
    }
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[2U]))) {
        bufp->chgIData(oldp+6,(vlSelfRef.CpuTop__DOT__pc),32);
        bufp->chgIData(oldp+7,(vlSelfRef.CpuTop__DOT__regs_0),32);
        bufp->chgIData(oldp+8,(vlSelfRef.CpuTop__DOT__regs_1),32);
        bufp->chgIData(oldp+9,(vlSelfRef.CpuTop__DOT__regs_2),32);
        bufp->chgIData(oldp+10,(vlSelfRef.CpuTop__DOT__regs_3),32);
        bufp->chgIData(oldp+11,(vlSelfRef.CpuTop__DOT__regs_4),32);
        bufp->chgIData(oldp+12,(vlSelfRef.CpuTop__DOT__regs_5),32);
        bufp->chgIData(oldp+13,(vlSelfRef.CpuTop__DOT__regs_6),32);
        bufp->chgIData(oldp+14,(vlSelfRef.CpuTop__DOT__regs_7),32);
        bufp->chgIData(oldp+15,(vlSelfRef.CpuTop__DOT__regs_8),32);
        bufp->chgIData(oldp+16,(vlSelfRef.CpuTop__DOT__regs_9),32);
        bufp->chgIData(oldp+17,(vlSelfRef.CpuTop__DOT__regs_10),32);
        bufp->chgIData(oldp+18,(vlSelfRef.CpuTop__DOT__regs_11),32);
        bufp->chgIData(oldp+19,(vlSelfRef.CpuTop__DOT__regs_12),32);
        bufp->chgIData(oldp+20,(vlSelfRef.CpuTop__DOT__regs_13),32);
        bufp->chgIData(oldp+21,(vlSelfRef.CpuTop__DOT__regs_14),32);
        bufp->chgIData(oldp+22,(vlSelfRef.CpuTop__DOT__regs_15),32);
        bufp->chgBit(oldp+23,(vlSelfRef.CpuTop__DOT__illegal_seen));
    }
    bufp->chgBit(oldp+24,(vlSelfRef.clock));
    bufp->chgBit(oldp+25,(vlSelfRef.reset));
    bufp->chgIData(oldp+26,(vlSelfRef.io_inst),32);
    bufp->chgIData(oldp+27,(vlSelfRef.io_pc),32);
    bufp->chgIData(oldp+28,(vlSelfRef.io_mem_rdata),32);
    bufp->chgIData(oldp+29,(vlSelfRef.io_mem_addr),32);
    bufp->chgIData(oldp+30,(vlSelfRef.io_mem_wdata),32);
    bufp->chgCData(oldp+31,(vlSelfRef.io_mem_wmask),4);
    bufp->chgBit(oldp+32,(vlSelfRef.io_mem_wen));
    bufp->chgBit(oldp+33,(vlSelfRef.io_mem_ren));
    bufp->chgIData(oldp+34,(((0x00040000U & vlSelfRef.io_inst)
    ...
    bufp->chgIData(oldp+35,(((0x00800000U & vlSelfRef.io_inst)
                              ...
                              : ((0x00400000U & vlSelfRef.io_inst)
                                  ...
                                  : ((0x00200000U & vlSelfRef.io_inst)
                                      ...
                                      : ((0x00100000U 
                                          ...
                                          ? vlSelfRef.CpuTop__DOT__regs_1
                                          : vlSelfRef.CpuTop__DOT__regs_0))))),32);
    bufp->chgIData(oldp+36,(((0x00004000U & vlSelfRef.io_inst)
    ...
    bufp->chgIData(oldp+37,(vlSelfRef.CpuTop__DOT__immI),32);
}
