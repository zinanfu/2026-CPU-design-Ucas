...
void VCpuTop___024root__trace_chg_0_sub_0(VCpuTop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[2U]))) {
        ...
        bufp->chgBit(oldp+92,(((~ (IData)(vlSelfRef.CpuTop__DOT__idu__DOT____VdfgRegularize_h52656aab_0_11)) 
                               & (0x67U == (0x0000007fU 
                                            & vlSelfRef.CpuTop__DOT__reg_inst)))));
        bufp->chgBit(oldp+93,(((IData)(vlSelfRef.CpuTop__DOT__idu__DOT____VdfgRegularize_h52656aab_0_9) 
        ...
        bufp->chgCData(oldp+94,(((1U & ((~ ((~ (0U 
                                  ...
                                  ? 0U : 0x0bU)),4);
        bufp->chgBit(oldp+95,(((IData)(vlSelfRef.CpuTop__DOT__idu__DOT____VdfgRegularize_h52656aab_0_9) 
                               & (0x18U == (vlSelfRef.CpuTop__DOT__reg_inst 
                                            >> 0x00000019U)))));
        bufp->chgBit(oldp+96,(vlSelfRef.CpuTop__DOT___wbu_io_reg_wen));
