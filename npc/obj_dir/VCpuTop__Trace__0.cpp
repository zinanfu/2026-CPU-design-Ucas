...
void VCpuTop___024root__trace_chg_0_sub_0(VCpuTop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->chgIData(oldp+35,(vlSelfRef.io_debug_pc),32);
    bufp->chgIData(oldp+36,(vlSelfRef.io_debug_inst),32);
    bufp->chgBit(oldp+37,(vlSelfRef.io_debug_valid));
    bufp->chgWData(oldp+38,(vlSelfRef.io_debug_regs_flat),1024);
    bufp->chgIData(oldp+70,(((0x00040000U & vlSelfRef.io_inst)
    ...
    bufp->chgBit(oldp+71,(vlSelfRef.CpuTop__DOT__illegal));
    bufp->chgIData(oldp+72,(vlSelfRef.CpuTop__DOT__immI),32);
    bufp->chgIData(oldp+73,((0xfffff000U & vlSelfRef.io_inst)),32);
}
