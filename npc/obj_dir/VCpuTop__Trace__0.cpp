...
void VCpuTop___024root__trace_chg_0_sub_0(VCpuTop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[2U]))) {
        ...
        bufp->chgBit(oldp+88,(((~ (IData)(vlSelfRef.CpuTop__DOT__idu__DOT___GEN_32)) 
                               & (IData)(vlSelfRef.CpuTop__DOT__idu__DOT___GEN_33))));
        ...
        bufp->chgIData(oldp+91,((0x0000001fU & (vlSelfRef.CpuTop__DOT__reg_inst 
                                                >> 0x0000000fU))),32);
        bufp->chgBit(oldp+92,(((~ (IData)(vlSelfRef.CpuTop__DOT__idu__DOT____VdfgRegularize_h52656aab_0_12)) 
                               & (0x67U == (0x0000007fU 
                                            & vlSelfRef.CpuTop__DOT__reg_inst)))));
        ...
        bufp->chgIData(oldp+130,((0xfffff000U & vlSelfRef.CpuTop__DOT__reg_inst)),32);
        ...
        bufp->chgIData(oldp+138,(vlSelfRef.CpuTop__DOT__ifu__DOT__io_si_pc_REG),32);
        bufp->chgIData(oldp+139,(vlSelfRef.CpuTop__DOT__ifu__DOT__io_si_inst_REG),32);
    }
    ...
    bufp->chgIData(oldp+185,(vlSelfRef.io_si_pc),32);
    bufp->chgIData(oldp+186,(vlSelfRef.io_si_inst),32);
