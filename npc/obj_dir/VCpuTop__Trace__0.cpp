...
void VCpuTop___024root__trace_chg_0_sub_0(VCpuTop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+38,(vlSelfRef.clock));
    bufp->chgBit(oldp+39,(vlSelfRef.reset));
    bufp->chgIData(oldp+40,(vlSelfRef.io_inst),32);
    bufp->chgIData(oldp+41,(vlSelfRef.io_pc),32);
    bufp->chgIData(oldp+42,(vlSelfRef.io_mem_rdata),32);
    bufp->chgIData(oldp+43,(vlSelfRef.io_mem_addr),32);
    bufp->chgIData(oldp+44,(vlSelfRef.io_mem_wdata),32);
    bufp->chgBit(oldp+45,(vlSelfRef.io_mem_wen));
    bufp->chgBit(oldp+46,(vlSelfRef.io_mem_ren));
}
