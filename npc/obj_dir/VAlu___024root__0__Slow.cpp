...
#endif
            VL_FATAL_MT("build/Alu.sv", 2, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 100 tries");
        }
...
VL_ATTR_COLD void VAlu___024root___ctor_var_reset(VAlu___024root* vlSelf) {
    ...
    vlSelf->io_op = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 2536292131817234354ull);
