...
VL_ATTR_COLD void VCpuTop___024root___ctor_var_reset(VCpuTop___024root* vlSelf) {
    ...
    vlSelf->CpuTop__DOT___GEN_6 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 320616168855322035ull);
    ...
    vlSelf->CpuTop__DOT___wb_data_T_16 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 10519960221965154405ull);
    vlSelf->CpuTop__DOT___GEN_26 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8194491634921639075ull);
    vlSelf->CpuTop__DOT___GEN_27 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 9127224772278025785ull);
