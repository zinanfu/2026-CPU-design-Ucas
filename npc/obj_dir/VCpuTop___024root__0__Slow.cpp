...
VL_ATTR_COLD void VCpuTop___024root___stl_sequent__TOP__0(VCpuTop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*0:0*/ CpuTop__DOT____VdfgRegularize_h9f7eeac2_0_4;
    CpuTop__DOT____VdfgRegularize_h9f7eeac2_0_4 = 0;
    // Body
    vlSelfRef.io_pc = vlSelfRef.CpuTop__DOT__pc;
    vlSelfRef.CpuTop__DOT___wb_data_T_6 = ((IData)(4U) 
                                           + vlSelfRef.CpuTop__DOT__pc);
    vlSelfRef.CpuTop__DOT___GEN_12 = (((- (IData)((vlSelfRef.io_inst 
                                                   >> 0x0000001fU))) 
                                       << 0x0000000cU) 
                                      | ((0x00000800U 
                                          & (vlSelfRef.io_inst 
    ...
    vlSelfRef.CpuTop__DOT____VdfgRegularize_h9f7eeac2_0_3 
        = (IData)((0x00000033U == (0x0000707fU & vlSelfRef.io_inst)));
    CpuTop__DOT____VdfgRegularize_h9f7eeac2_0_4 = (
                                                   (0x17U 
                                                    == 
                                                    (0x0000007fU 
                                                     & vlSelfRef.io_inst)) 
                                             ...
                                             : ((0x00020000U 
                                                ...
                                                ((0x00010000U 
                                                 ...
                                                 ((0x00008000U 
                                                   ...
                                                   ? vlSelfRef.CpuTop__DOT__regs_1
                                                   : vlSelfRef.CpuTop__DOT__regs_0)))));
    vlSelfRef.CpuTop__DOT___GEN_14 = (((0x13U == (0x0000007fU 
                                                  & vlSelfRef.io_inst))
                                        ? (0U == (7U 
                                                  & (vlSelfRef.io_inst 
                                                     >> 0x0000000cU)))
                                        : ((0x37U == 
                                            (0x0000007fU 
                                             & vlSelfRef.io_inst)) 
                                           | ((IData)(CpuTop__DOT____VdfgRegularize_h9f7eeac2_0_4) 
                                              | ((0x67U 
                                                  == 
                                                  (0x0000007fU 
                                                   & vlSelfRef.io_inst)) 
                                      ...
                                      & (0U != (0x0000001fU 
                                                & (vlSelfRef.io_inst 
                                                   >> 7U))));
    vlSelfRef.CpuTop__DOT___GEN_7 = ((0x13U == (0x0000007fU 
                                                & vlSelfRef.io_inst)) 
                                     | ((0x37U == (0x0000007fU 
                                                   & vlSelfRef.io_inst)) 
                                        | ((IData)(CpuTop__DOT____VdfgRegularize_h9f7eeac2_0_4) 
    ...
    vlSelfRef.CpuTop__DOT__rs1_data = ((0U != (0x0000001fU 
                                        ...
                                        : 0U);
    vlSelfRef.io_mem_ren = ((~ (IData)(vlSelfRef.CpuTop__DOT___GEN_7)) 
                            & (3U == (0x0000007fU & vlSelfRef.io_inst)));
    vlSelfRef.CpuTop__DOT___GEN_9 = ((IData)(vlSelfRef.CpuTop__DOT___GEN_7) 
                                     | (3U == (0x0000007fU 
                                               & vlSelfRef.io_inst)));
    vlSelfRef.CpuTop__DOT___GEN_11 = (vlSelfRef.CpuTop__DOT__rs1_data 
    ...
    vlSelfRef.CpuTop__DOT___next_pc_T_4 = (vlSelfRef.CpuTop__DOT__rs1_data 
                                           + (((- (IData)(
                                              ...
                                              | (vlSelfRef.io_inst 
                                                 >> 0x00000014U)));
    vlSelfRef.io_mem_wen = ((~ (IData)(vlSelfRef.CpuTop__DOT___GEN_9)) 
                            & (0x23U == (0x0000007fU 
                                         & vlSelfRef.io_inst)));
    ...
    vlSelfRef.io_mem_addr = ((IData)(vlSelfRef.CpuTop__DOT___GEN_7)
                              ? 0U : ((3U == (0x0000007fU 
                                              & vlSelfRef.io_inst))
...
VL_ATTR_COLD void VCpuTop___024root___ctor_var_reset(VCpuTop___024root* vlSelf) {
    ...
    vlSelf->CpuTop__DOT___GEN_7 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3792545890637617226ull);
    ...
    vlSelf->CpuTop__DOT___wb_data_T_6 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 12055850744032632448ull);
    vlSelf->CpuTop__DOT___GEN_11 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3099457963869365788ull);
    vlSelf->CpuTop__DOT___GEN_12 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 15002294100970415828ull);
