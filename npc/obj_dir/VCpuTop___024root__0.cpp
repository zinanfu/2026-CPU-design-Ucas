...
void VCpuTop___024root____Vdpiimwrap_CpuTop__DOT__ifuSram__DOT__paddrRead__DOT__paddr_read_TOP(IData/*31:0*/ addr, IData/*31:0*/ len, CData/*0:0*/ is_inst, IData/*31:0*/ &paddr_read__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCpuTop___024root____Vdpiimwrap_CpuTop__DOT__ifuSram__DOT__paddrRead__DOT__paddr_read_TOP\n"); );
    // Body
    int addr__Vcvt;
    addr__Vcvt = addr;
    int len__Vcvt;
...
void VCpuTop___024root____Vdpiimwrap_CpuTop__DOT__ifuSram__DOT__paddrWrite__DOT__paddr_write_TOP(IData/*31:0*/ addr, IData/*31:0*/ len, IData/*31:0*/ data, IData/*31:0*/ wmask, CData/*0:0*/ is_inst) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCpuTop___024root____Vdpiimwrap_CpuTop__DOT__ifuSram__DOT__paddrWrite__DOT__paddr_write_TOP\n"); );
    // Body
    int addr__Vcvt;
    addr__Vcvt = addr;
    int len__Vcvt;
...
void VCpuTop___024root___nba_sequent__TOP__0(VCpuTop___024root* vlSelf) {
    ...
    CData/*0:0*/ __Vdly__CpuTop__DOT__memSram__DOT__rvalidReg;
    __Vdly__CpuTop__DOT__memSram__DOT__rvalidReg = 0;
    CData/*0:0*/ __Vdly__CpuTop__DOT__memSram__DOT__bvalidreg;
    __Vdly__CpuTop__DOT__memSram__DOT__bvalidreg = 0;
    // Body
    __Vdly__CpuTop__DOT__ifu__DOT__state = vlSelfRef.CpuTop__DOT__ifu__DOT__state;
    __Vdly__CpuTop__DOT__memSram__DOT__bvalidreg = vlSelfRef.CpuTop__DOT__memSram__DOT__bvalidreg;
    __Vdly__CpuTop__DOT__memSram__DOT__rvalidReg = vlSelfRef.CpuTop__DOT__memSram__DOT__rvalidReg;
    ...
    vlSelfRef.CpuTop__DOT__ifuSram__DOT__rvalidReg 
        = ((1U & (~ (IData)(vlSelfRef.reset))) && ((IData)(vlSelfRef.CpuTop__DOT__ifuSram__DOT__io_axi_ar_valid) 
                                                   | ((~ 
                                                       ((IData)(vlSelfRef.CpuTop__DOT__ifuSram__DOT__rvalidReg) 
                                                        & (IData)(vlSelfRef.CpuTop__DOT__ifuSram__DOT__io_axi_r_ready))) 
                                                      & (IData)(vlSelfRef.CpuTop__DOT__ifuSram__DOT__rvalidReg))));
    ...
    __Vdly__CpuTop__DOT__memSram__DOT__bvalidreg = 
        ((1U & (~ (IData)(vlSelfRef.reset))) && ((IData)(vlSelfRef.CpuTop__DOT__memSram__DOT__writeFire) 
                                                 | ((~ 
                                                    ...
                                                    & (IData)(vlSelfRef.CpuTop__DOT__memSram__DOT__bvalidreg))));
    __Vdly__CpuTop__DOT__memSram__DOT__rvalidReg = 
        ((1U & (~ (IData)(vlSelfRef.reset))) && ((IData)(vlSelfRef.CpuTop__DOT__memSram__DOT__io_axi_ar_valid) 
                                                 | ((~ 
                                                     ((IData)(vlSelfRef.CpuTop__DOT__memSram__DOT__rvalidReg) 
                                                      & (IData)(vlSelfRef.CpuTop__DOT__memSram__DOT__io_axi_r_ready))) 
                                                    & (IData)(vlSelfRef.CpuTop__DOT__memSram__DOT__rvalidReg))));
    ...
    if (vlSelfRef.reset) {
        ...
        vlSelfRef.CpuTop__DOT__memSram__DOT__rdataReg = 0U;
        ...
        if (vlSelfRef.CpuTop__DOT__redirect_valid) {
            ...
            if (vlSelfRef.CpuTop__DOT__ifuSram__DOT__io_axi_ar_valid) {
                __Vdly__CpuTop__DOT__ifu__DOT__state = 1U;
            }
        } else if (vlSelfRef.CpuTop__DOT__ifu__DOT___GEN) {
            if (vlSelfRef.CpuTop__DOT__ifu__DOT___GEN_3) {
        ...
        if (vlSelfRef.CpuTop__DOT__memSram__DOT__io_axi_ar_valid) {
            vlSelfRef.CpuTop__DOT__memSram__DOT__rdataReg 
                = vlSelfRef.CpuTop__DOT__memSram__DOT___paddrRead_data;
        }
    ...
    if (vlSelfRef.CpuTop__DOT___reg_T_2) {
        vlSelfRef.CpuTop__DOT__reg_2_mem_wmask = (0x0000000fU 
                                                  & ((IData)(vlSelfRef.CpuTop__DOT__exu__DOT___GEN_0)
                                                     ...
                                                     ((IData)(vlSelfRef.CpuTop__DOT__exu__DOT___GEN)
                                                      ...
                                                      ((IData)(1U) 
                                                       ...
                                                       (3U 
                                                        & vlSelfRef.CpuTop__DOT__exu__DOT__alu__DOT__io_out))
                                                       : (IData)(vlSelfRef.CpuTop__DOT__reg_1_mem_wmask))));
        vlSelfRef.CpuTop__DOT__reg_2_mem_wen = vlSelfRef.CpuTop__DOT__reg_1_mem_wen;
    }
    if (((IData)(vlSelfRef.CpuTop__DOT___mem_io_in_ready) 
         & ((IData)(vlSelfRef.CpuTop__DOT__reg_2_mem_ren)
             ? (IData)(vlSelfRef.CpuTop__DOT__memSram__DOT__io_axi_ar_valid)
    ...
    if (vlSelfRef.reset) {
                                                      ...
                                                      | ((0x00000800U 
                                                         ...
                                                         | ((0x000007e0U 
                                                            ...
                                                            | (0x0000001eU 
                                                               & (vlSelfRef.CpuTop__DOT__reg_inst 
                                                                  >> 7U))))))))));
        } else if (vlSelfRef.CpuTop__DOT__ifu__DOT___GEN_2) {
        ...
        if (vlSelfRef.CpuTop__DOT__mem__DOT___GEN) {
            if (vlSelfRef.CpuTop__DOT__reg_valid_2) {
                ...
                } else if (vlSelfRef.CpuTop__DOT__mem__DOT___GEN_3) {
                    vlSelfRef.CpuTop__DOT__mem__DOT__state = 2U;
                }
            }
        } else if (((IData)(vlSelfRef.CpuTop__DOT__mem__DOT___GEN_1)
                     ? ((IData)(vlSelfRef.CpuTop__DOT__memSram__DOT__rvalidReg) 
                        & (IData)(vlSelfRef.CpuTop__DOT__memSram__DOT__io_axi_r_ready))
                     : (((IData)(vlSelfRef.CpuTop__DOT__mem__DOT___GEN_2) 
                         & (IData)(vlSelfRef.CpuTop__DOT__memSram__DOT__io_axi_b_ready)) 
                        & (IData)(vlSelfRef.CpuTop__DOT__memSram__DOT__bvalidreg)))) {
            vlSelfRef.CpuTop__DOT__mem__DOT__state = 0U;
        }
    ...
    vlSelfRef.CpuTop__DOT__memSram__DOT__rvalidReg 
        = __Vdly__CpuTop__DOT__memSram__DOT__rvalidReg;
    vlSelfRef.CpuTop__DOT__memSram__DOT__bvalidreg 
        = __Vdly__CpuTop__DOT__memSram__DOT__bvalidreg;
    ...
    if ((0U == (IData)(vlSelfRef.CpuTop__DOT__mem__DOT__state))) {
        ...
        vlSelfRef.CpuTop__DOT___mem_io_in_ready = vlSelfRef.CpuTop__DOT__reg_valid_2;
    } else {
        vlSelfRef.CpuTop__DOT___mem_io_out_bits_wb_addr 
            = vlSelfRef.CpuTop__DOT__mem__DOT__reqReg_wb_addr;
        vlSelfRef.CpuTop__DOT___mem_io_out_bits_wb_en 
        ...
        vlSelfRef.CpuTop__DOT___mem_io_out_valid = 
            ((1U == (IData)(vlSelfRef.CpuTop__DOT__mem__DOT__state))
              ...
              : ((2U == (IData)(vlSelfRef.CpuTop__DOT__mem__DOT__state)) 
                 & (IData)(vlSelfRef.CpuTop__DOT__memSram__DOT__bvalidreg)));
        vlSelfRef.CpuTop__DOT___mem_io_in_ready = 0U;
    }
    ...
    vlSelfRef.CpuTop__DOT__idu_io_out_ready = (1U & 
                                               ((~ (IData)(vlSelfRef.CpuTop__DOT__reg_valid_1)) 
                                                | (IData)(vlSelfRef.CpuTop__DOT___exu_io_in_ready)));
    vlSelfRef.CpuTop__DOT__memSram__DOT__io_axi_ar_valid 
        = ((IData)(vlSelfRef.CpuTop__DOT___mem_io_in_ready) 
           & (IData)(vlSelfRef.CpuTop__DOT__reg_2_mem_ren));
    ...
    if (vlSelfRef.reset) {
        ...
        vlSelfRef.CpuTop__DOT__ifuSram__DOT__rdataReg = 0U;
    } else {
        if ((1U & (~ ((IData)(vlSelfRef.CpuTop__DOT__ifu__DOT___GEN_1) 
                      | (~ ((1U == (IData)(vlSelfRef.CpuTop__DOT__ifu__DOT__state)) 
                            & (IData)(vlSelfRef.CpuTop__DOT__ifu__DOT___GEN_3))))))) {
            vlSelfRef.CpuTop__DOT__ifu__DOT__outInstReg 
                = vlSelfRef.CpuTop__DOT__ifuSram__DOT__rdataReg;
        }
        if (vlSelfRef.CpuTop__DOT__ifuSram__DOT__io_axi_ar_valid) {
            vlSelfRef.CpuTop__DOT__ifuSram__DOT__rdataReg 
                = vlSelfRef.CpuTop__DOT__ifuSram__DOT___paddrRead_data;
        }
    }
    vlSelfRef.CpuTop__DOT__exu__DOT__csr__DOT__casez_tmp 
...
void VCpuTop___024root___nba_sequent__TOP__1(VCpuTop___024root* vlSelf) {
    ...
    VCpuTop___024root____Vdpiimwrap_CpuTop__DOT__ifuSram__DOT__paddrWrite__DOT__paddr_write_TOP(
                                                                                ...
                                                                                ((IData)(vlSelfRef.CpuTop__DOT__mem__DOT___GEN_0)
                                                                                 ...
                                                                                 : 0U), vlSelfRef.CpuTop__DOT__memSram__DOT____Vcellinp__paddrWrite__len, 
                                                                                ((IData)(vlSelfRef.CpuTop__DOT__mem__DOT___GEN_0)
                                                                                 ? 0U
...
void VCpuTop___024root___nba_sequent__TOP__2(VCpuTop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.CpuTop__DOT__mem__DOT___GEN_0 = (1U & 
                                               ((~ (IData)(vlSelfRef.CpuTop__DOT___mem_io_in_ready)) 
                                                | ((~ (IData)(vlSelfRef.CpuTop__DOT__reg_2_mem_wen)) 
                                                   | (IData)(vlSelfRef.CpuTop__DOT__reg_2_mem_ren))));
    vlSelfRef.CpuTop__DOT__memSram__DOT__writeFire 
    ...
    if (vlSelfRef.CpuTop__DOT___reg_T_2) {
        vlSelfRef.CpuTop__DOT__reg_2_mem_addr = (0xfffffffcU 
                                                 & vlSelfRef.CpuTop__DOT__exu__DOT__alu__DOT__io_out);
        vlSelfRef.CpuTop__DOT__reg_2_mem_wdata = ((IData)(vlSelfRef.CpuTop__DOT__exu__DOT___GEN_0)
                                                   ? 
                                                  ((0x0000ffffU 
    ...
    vlSelfRef.CpuTop__DOT__mem__DOT___GEN_3 = ((IData)(vlSelfRef.CpuTop__DOT__reg_2_mem_wen) 
                                               & (IData)(vlSelfRef.CpuTop__DOT__memSram__DOT__writeFire));
    ...
    vlSelfRef.CpuTop__DOT___reg_T_2 = ((IData)(vlSelfRef.CpuTop__DOT___exu_io_in_ready) 
                                       & (IData)(vlSelfRef.CpuTop__DOT__reg_valid_1));
    VCpuTop___024root____Vdpiimwrap_CpuTop__DOT__ifuSram__DOT__paddrRead__DOT__paddr_read_TOP(
                                                                                ((IData)(vlSelfRef.CpuTop__DOT__memSram__DOT__io_axi_ar_valid)
                                                                                 ? vlSelfRef.CpuTop__DOT__reg_2_mem_addr
                                                                                 : 0U), 4U, 0U, vlSelfRef.__Vfunc_CpuTop__DOT__memSram__DOT__paddrRead__DOT__paddr_read__2__Vfuncout);
    vlSelfRef.CpuTop__DOT__memSram__DOT___paddrRead_data 
        = vlSelfRef.__Vfunc_CpuTop__DOT__memSram__DOT__paddrRead__DOT__paddr_read__2__Vfuncout;
    if (vlSelfRef.CpuTop__DOT___reg_T_1) {
    ...
    vlSelfRef.CpuTop__DOT__ifuSram__DOT__io_axi_ar_valid 
        = ((~ (IData)(vlSelfRef.CpuTop__DOT__redirect_valid)) 
           & (0U == (IData)(vlSelfRef.CpuTop__DOT__ifu__DOT__state)));
    vlSelfRef.CpuTop__DOT__ifuSram__DOT__io_axi_r_ready 
        = ((~ (IData)(vlSelfRef.CpuTop__DOT__ifu__DOT___GEN_1)) 
           & ((1U == (IData)(vlSelfRef.CpuTop__DOT__ifu__DOT__state)) 
              | ((2U != (IData)(vlSelfRef.CpuTop__DOT__ifu__DOT__state)) 
                 & (3U == (IData)(vlSelfRef.CpuTop__DOT__ifu__DOT__state)))));
    vlSelfRef.CpuTop__DOT__ifu__DOT___GEN_2 = ((0U 
                                                == (IData)(vlSelfRef.CpuTop__DOT__ifu__DOT__state)) 
                                               & (IData)(vlSelfRef.CpuTop__DOT__ifuSram__DOT__io_axi_ar_valid));
    VCpuTop___024root____Vdpiimwrap_CpuTop__DOT__ifuSram__DOT__paddrRead__DOT__paddr_read_TOP(
                                                                                ((IData)(vlSelfRef.CpuTop__DOT__ifuSram__DOT__io_axi_ar_valid)
                                                                                 ? vlSelfRef.CpuTop__DOT__ifu__DOT__pc
                                                                                 : 0U), 4U, 1U, vlSelfRef.__Vfunc_CpuTop__DOT__ifuSram__DOT__paddrRead__DOT__paddr_read__0__Vfuncout);
    vlSelfRef.CpuTop__DOT__ifuSram__DOT___paddrRead_data 
        = vlSelfRef.__Vfunc_CpuTop__DOT__ifuSram__DOT__paddrRead__DOT__paddr_read__0__Vfuncout;
    vlSelfRef.CpuTop__DOT__ifu__DOT___GEN_3 = ((IData)(vlSelfRef.CpuTop__DOT__ifuSram__DOT__rvalidReg) 
                                               & (IData)(vlSelfRef.CpuTop__DOT__ifuSram__DOT__io_axi_r_ready));
}
