...
void VCpuTop___024root___ico_sequent__TOP__0(VCpuTop___024root* vlSelf) {
    ...
    CpuTop__DOT___load_addr_T = (3U & (vlSelfRef.CpuTop__DOT__rs1_data 
                                       + (vlSelfRef.io_inst 
                                          >> 0x00000014U)));
    if (vlSelfRef.CpuTop__DOT____VdfgRegularize_h9f7eeac2_0_7) {
                                                  ...
                                                  & (~ 
                                                     (0U 
                                                      ...
                                                      (7U 
                                                       & (vlSelfRef.io_inst 
                                                          >> 0x0000000cU)))))));
        vlSelfRef.io_mem_addr = (vlSelfRef.CpuTop__DOT__rs1_data 
...
void VCpuTop___024root___nba_sequent__TOP__0(VCpuTop___024root* vlSelf) {
    ...
    CpuTop__DOT___load_addr_T = 0;
    // Body
    if (VL_UNLIKELY(((1U & ((IData)(vlSelfRef.CpuTop__DOT___GEN_18) 
    ...
    if (vlSelfRef.reset) {
                                          ...
                                          : ((0x67U 
                                              ...
                                              : ((0x63U 
                                                 ...
                                                 ((IData)(
                                                   ...
                                                   ? 
                                                  (vlSelfRef.CpuTop__DOT__pc 
                                                   + vlSelfRef.CpuTop__DOT___GEN_21)
                                                   : 
                                                  ((IData)(
                                                           ((0x00006000U 
                                                             == 
                                                    ...
                                                    ((IData)(
                                                     ...
                                                     ((IData)(
                                                      ...
                                                      (vlSelfRef.CpuTop__DOT__pc 
                                                       + vlSelfRef.CpuTop__DOT___GEN_21))))))
                                                  : vlSelfRef.CpuTop__DOT___wb_data_T_9))));
        if (((IData)(vlSelfRef.CpuTop__DOT___GEN_17) 
        ...
        vlSelfRef.CpuTop__DOT__regs_0 = (((IData)(vlSelfRef.CpuTop__DOT___GEN_17) 
                                          & (~ (0U 
                                                != 
                                                (0x0000001fU 
                                                 & (vlSelfRef.io_inst 
    ...
    vlSelfRef.CpuTop__DOT___GEN_20 = (vlSelfRef.CpuTop__DOT__rs1_data 
                                      == vlSelfRef.CpuTop__DOT__rs2_data);
    vlSelfRef.io_mem_addr = ((IData)(vlSelfRef.CpuTop__DOT____VdfgRegularize_h9f7eeac2_0_7)
                              ? 0U : (vlSelfRef.CpuTop__DOT__rs1_data 
                                      + (((- (IData)(
                                                     (vlSelfRef.io_inst 
                                                      >> 0x0000001fU))) 
                                          << 0x0000000cU) 
