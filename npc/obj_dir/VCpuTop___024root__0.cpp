...
void VCpuTop___024root___nba_sequent__TOP__0(VCpuTop___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((1U & (((((((((0x13U != (0x0000007fU 
        ...
        VL_FWRITEF_NX(0x80000002U,"store_addr = 0x%x\nio.mem_addr = 0x%x\n",0,
                      ...
                      32,((IData)(vlSelfRef.CpuTop__DOT___GEN_12)
                           ? 0U : ((3U == (0x0000007fU 
                                           & vlSelfRef.io_inst))
                                    ? (0xfffffffcU 
                                       & vlSelfRef.CpuTop__DOT___next_pc_T_4)
    ...
    if (VL_UNLIKELY(((1U & ((IData)(vlSelfRef.CpuTop__DOT___GEN_21) 
                            & (~ (IData)(vlSelfRef.reset))))))) {
    ...
    if (vlSelfRef.reset) {
                                                    ...
                                                    ((IData)(
                                                     ...
                                                     ((IData)(
                                                      ...
                                                      (vlSelfRef.CpuTop__DOT__pc 
                                                       + vlSelfRef.CpuTop__DOT___GEN_23))))))
                                                  : vlSelfRef.CpuTop__DOT___wb_data_T_9))));
        if (((IData)(vlSelfRef.CpuTop__DOT___GEN_20) 
        ...
        vlSelfRef.CpuTop__DOT__regs_0 = (((IData)(vlSelfRef.CpuTop__DOT___GEN_20) 
                                          & (0U == 
                                             (0x00000780U 
                                              & vlSelfRef.io_inst)))
