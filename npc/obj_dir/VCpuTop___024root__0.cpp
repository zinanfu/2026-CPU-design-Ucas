                                  ...
                                  : ((IData)(vlSelfRef.CpuTop__DOT__idu__DOT___GEN_28)
                                      ? ((5U == (7U 
                                          ...
                                          : ((1U == 
                                              ...
                                              : vlSelfRef.CpuTop__DOT___idu_io_out_bits_mem_wdata))
                                      : vlSelfRef.CpuTop__DOT___idu_io_out_bits_mem_wdata))))))));
    vlSelfRef.CpuTop__DOT__idu__DOT___GEN_15 = ((0U 
                                                 != 
                                                 (7U 
                                                  & (vlSelfRef.CpuTop__DOT__reg_inst 
                                                     >> 0x0000000cU)))
...
void VCpuTop___024root___nba_sequent__TOP__0(VCpuTop___024root* vlSelf) {
    ...
    CData/*0:0*/ __Vdly__CpuTop__DOT__reg_valid_1;
    __Vdly__CpuTop__DOT__reg_valid_1 = 0;
    ...
    // Body
    __Vdly__CpuTop__DOT__reg_valid_1 = vlSelfRef.CpuTop__DOT__reg_valid_1;
    ...
    if (VL_UNLIKELY(((1U & (((0x63U == (0x0000007fU 
                                        & vlSelfRef.CpuTop__DOT__reg_inst)) 
                             & (IData)(vlSelfRef.CpuTop__DOT__reg_valid)) 
                            & (~ (IData)(vlSelfRef.reset))))))) {
        VL_FWRITEF_NX(0x80000002U,"IDU branch: pc=%x rs1_data=%x rs2_data=%x taken=%1#\n",0,
                      32,vlSelfRef.CpuTop__DOT__reg_pc,
                      32,vlSelfRef.CpuTop__DOT___idu_io_out_bits_csr_wdata,
                      32,vlSelfRef.CpuTop__DOT___idu_io_out_bits_mem_wdata,
                      1,((IData)(vlSelfRef.CpuTop__DOT__idu__DOT____VdfgRegularize_h52656aab_0_7) 
                         & ((0x63U == (0x0000007fU 
                                       & vlSelfRef.CpuTop__DOT__reg_inst)) 
                            & (IData)(vlSelfRef.CpuTop__DOT__idu__DOT___GEN_15))));
    }
    ...
    if (VL_UNLIKELY(((1U & (((IData)(vlSelfRef.CpuTop__DOT__reg_2_mem_ren) 
                             & (IData)(vlSelfRef.CpuTop__DOT__reg_valid_2)) 
                            & (~ (IData)(vlSelfRef.reset))))))) {
        VL_FWRITEF_NX(0x80000002U,"MEM load: pc=%x addr=%x raw=%x processed=%x\n",0,
                      32,vlSelfRef.CpuTop__DOT__reg_2_pc,
                      32,vlSelfRef.CpuTop__DOT__reg_2_mem_addr,
                      32,vlSelfRef.io_mem_rdata,32,
                      ((IData)(vlSelfRef.CpuTop__DOT__reg_2_mem_ren)
                        ? ((4U & (IData)(vlSelfRef.CpuTop__DOT__reg_2_mem_funct3))
                            ? ((2U & (IData)(vlSelfRef.CpuTop__DOT__reg_2_mem_funct3))
                                ? 0U : ((1U & (IData)(vlSelfRef.CpuTop__DOT__reg_2_mem_funct3))
                                            ...
                                            & ((IData)(vlSelfRef.CpuTop__DOT__ifu_io_out_ready) 
                                               | ((~ 
                                                   (((~ (IData)(vlSelfRef.CpuTop__DOT__idu__DOT__stall)) 
                                                    ...
                                                    | (IData)(vlSelfRef.CpuTop__DOT__redirect_valid))) 
                                                  & (IData)(vlSelfRef.CpuTop__DOT__reg_valid)))));
    __Vdly__CpuTop__DOT__reg_valid_1 = ((1U & (~ (IData)(vlSelfRef.reset))) 
    ...
    if (vlSelfRef.reset) {
        ...
        vlSelfRef.CpuTop__DOT__ifu__DOT__io_si_inst_REG = 0U;
        ...
        vlSelfRef.CpuTop__DOT__ifu__DOT__io_si_pc_REG = 0U;
        ...
        vlSelfRef.CpuTop__DOT__ifu__DOT__io_si_inst_REG 
            = vlSelfRef.io_inst;
        ...
        vlSelfRef.CpuTop__DOT__ifu__DOT__io_si_pc_REG 
            = vlSelfRef.CpuTop__DOT__ifu__DOT__pc;
        if (((IData)(vlSelfRef.CpuTop__DOT__reg_1_csr_en) 
    ...
    if (vlSelfRef.CpuTop__DOT___idu_io_out_valid) {
        ...
        vlSelfRef.CpuTop__DOT__reg_1_exception_cause 
            = ((1U & ((~ ((~ (0U != (7U & (vlSelfRef.CpuTop__DOT__reg_inst 
                ...
                ? 0U : 0x0bU);
        vlSelfRef.CpuTop__DOT__reg_1_mret = ((IData)(vlSelfRef.CpuTop__DOT__idu__DOT____VdfgRegularize_h52656aab_0_10) 
                                             & (0x18U 
                                                == 
                                                (vlSelfRef.CpuTop__DOT__reg_inst 
                                                 >> 0x00000019U)));
        vlSelfRef.CpuTop__DOT__reg_1_is_jalr = ((~ (IData)(vlSelfRef.CpuTop__DOT__idu__DOT____VdfgRegularize_h52656aab_0_12)) 
                                                & (0x67U 
                                                   == 
                                                   (0x0000007fU 
                                                    & vlSelfRef.CpuTop__DOT__reg_inst)));
        ...
        vlSelfRef.CpuTop__DOT__reg_1_csr_en = ((~ (IData)(vlSelfRef.CpuTop__DOT__idu__DOT___GEN_32)) 
                                               & (IData)(vlSelfRef.CpuTop__DOT__idu__DOT___GEN_33));
        vlSelfRef.CpuTop__DOT__reg_1_exception = ((IData)(vlSelfRef.CpuTop__DOT__idu__DOT____VdfgRegularize_h52656aab_0_10) 
                                                  & (IData)(vlSelfRef.CpuTop__DOT__idu__DOT____VdfgRegularize_h52656aab_0_9));
    ...
    vlSelfRef.CpuTop__DOT__exu__DOT___GEN_0 = ((IData)(vlSelfRef.CpuTop__DOT__reg_1_mem_wen) 
                                               & (1U 
                                                  == (IData)(vlSelfRef.CpuTop__DOT__reg_1_mem_funct3)));
    vlSelfRef.CpuTop__DOT__reg_valid_1 = __Vdly__CpuTop__DOT__reg_valid_1;
    ...
    vlSelfRef.CpuTop__DOT__idu__DOT___GEN_33 = ((0x73U 
                                                ...
                                                & (0U 
                                                   ...
                                                   (7U 
                                                    & (vlSelfRef.CpuTop__DOT__reg_inst 
                                                       >> 0x0000000cU))));
    vlSelfRef.CpuTop__DOT__idu__DOT____VdfgRegularize_h52656aab_0_9 
    ...
    vlSelfRef.CpuTop__DOT__idu__DOT___GEN_31 = ((0x23U 
                                                ...
                                                | (0x33U 
                                                   ...
                                                   (0x0000007fU 
                                                    & vlSelfRef.CpuTop__DOT__reg_inst)));
    vlSelfRef.CpuTop__DOT__idu__DOT____VdfgRegularize_h52656aab_0_12 
        = ((0x13U == (0x0000007fU & vlSelfRef.CpuTop__DOT__reg_inst)) 
                ...
                : ((0x00400000U & vlSelfRef.CpuTop__DOT__reg_inst)
                    ...
                    : ((0x00200000U & vlSelfRef.CpuTop__DOT__reg_inst)
                        ...
                        : ((0x00100000U & vlSelfRef.CpuTop__DOT__reg_inst)
                            ? vlSelfRef.CpuTop__DOT__idu__DOT__regfile__DOT__regs_1
                            : 0U)))));
    vlSelfRef.CpuTop__DOT__idu__DOT___GEN_22 = ((IData)(vlSelfRef.CpuTop__DOT__idu__DOT____VdfgRegularize_h52656aab_0_12) 
                                                | ((0x67U 
                                                    == 
                                                    (0x0000007fU 
                                                     & vlSelfRef.CpuTop__DOT__reg_inst)) 
    ...
    vlSelfRef.CpuTop__DOT__idu__DOT____VdfgRegularize_h52656aab_0_7 
        = (1U & (~ ((0x13U == (0x0000007fU & vlSelfRef.CpuTop__DOT__reg_inst)) 
