...
void VCpuTop___024root___nba_sequent__TOP__0(VCpuTop___024root* vlSelf) {
    ...
    __Vdly__CpuTop__DOT__axiSram__DOT__rvalidReg = 
        ((1U & (~ (IData)(vlSelfRef.reset))) && ((IData)(vlSelfRef.CpuTop__DOT__axiArbiter__DOT__io_mem_ar_valid) 
                                                 | ((~ 
    ...
    if (vlSelfRef.reset) {
        ...
        if (vlSelfRef.CpuTop__DOT__redirect_valid) {
            ...
            if (vlSelfRef.CpuTop__DOT__ifu__DOT___GEN_0) {
            ...
            if (vlSelfRef.CpuTop__DOT__ifu__DOT___GEN_3) {
                __Vdly__CpuTop__DOT__ifu__DOT__pc = 
                    ((IData)(4U) + vlSelfRef.CpuTop__DOT__ifu__DOT__pc);
            }
        }
