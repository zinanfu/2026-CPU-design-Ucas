...
void VCpuTop___024root___ico_sequent__TOP__0(VCpuTop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.CpuTop__DOT___GEN_20 = (((- (IData)((vlSelfRef.io_inst 
                                                   >> 0x0000001fU))) 
                                       << 0x0000000cU) 
                                      | ((0x00000800U 
                                          & (vlSelfRef.io_inst 
    ...
    vlSelfRef.CpuTop__DOT___GEN_14 = ((IData)(vlSelfRef.CpuTop__DOT___GEN_12) 
                                      | (3U == (0x0000007fU 
                                                & vlSelfRef.io_inst)));
    ...
    vlSelfRef.CpuTop__DOT___GEN_17 = (((0x13U == (0x0000007fU 
                                      ...
                                      & (0U != (0x0000001fU 
                                                & (vlSelfRef.io_inst 
                                                   >> 7U))));
    vlSelfRef.CpuTop__DOT___GEN_19 = (vlSelfRef.CpuTop__DOT__rs1_data 
    ...
    vlSelfRef.CpuTop__DOT___GEN_18 = ((~ (IData)(vlSelfRef.CpuTop__DOT___GEN_17)) 
...
void VCpuTop___024root___nba_sequent__TOP__0(VCpuTop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if (VL_UNLIKELY(((1U & (((~ (IData)(vlSelfRef.CpuTop__DOT___GEN_17)) 
                             & ((~ (IData)(vlSelfRef.CpuTop__DOT__illegal_seen)) 
                                & ((0x13U == (0x0000007fU 
                                              & vlSelfRef.io_inst))
                                    ? ((~ (IData)(vlSelfRef.CpuTop__DOT___GEN_3)) 
                                          ...
                                          : ((0x67U 
                                              ...
                                              : ((0x63U 
                                                 ...
                                                 ((IData)(
                                                   ...
                                                   ? 
                                                  (vlSelfRef.CpuTop__DOT__pc 
                                                   + vlSelfRef.CpuTop__DOT___GEN_20)
                                                   : 
                                                  ((IData)(
                                                           ((0x00006000U 
                                                             == 
                                                   ...
                                                   ((IData)(
                                                            ((0x00005000U 
                                                              ...
                                                              (0x00007000U 
                                                               & vlSelfRef.io_inst)) 
                                                             & VL_GTS_III(32, vlSelfRef.CpuTop__DOT__rs1_data, vlSelfRef.CpuTop__DOT__rs2_data)))
                                                     ? 
                                                    (vlSelfRef.CpuTop__DOT__pc 
                                                     + vlSelfRef.CpuTop__DOT___GEN_20)
                                                     : 
