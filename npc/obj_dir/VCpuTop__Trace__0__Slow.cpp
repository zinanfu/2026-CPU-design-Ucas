...
VL_ATTR_COLD void VCpuTop___024root__trace_init_sub__TOP__0(VCpuTop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBus(c+41,0,"io_inst",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+43,0,"io_mem_rdata",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+44,0,"io_mem_addr",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+45,0,"io_mem_wdata",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+46,0,"io_mem_wmask",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBit(c+47,0,"io_mem_wen",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+48,0,"io_mem_ren",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
    ...
    tracep->declBus(c+22,0,"regs_16",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+23,0,"regs_17",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+24,0,"regs_18",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+25,0,"regs_19",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+26,0,"regs_20",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+27,0,"regs_21",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+28,0,"regs_22",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+29,0,"regs_23",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+30,0,"regs_24",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+31,0,"regs_25",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+32,0,"regs_26",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+33,0,"regs_27",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+34,0,"regs_28",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+35,0,"regs_29",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+36,0,"regs_30",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+37,0,"regs_31",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+0,0,"casez_tmp",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+2,0,"casez_tmp_0",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBit(c+38,0,"illegal_seen",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+49,0,"immI",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
...
VL_ATTR_COLD void VCpuTop___024root__trace_full_0_sub_0(VCpuTop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+0,(vlSelfRef.CpuTop__DOT__casez_tmp),32);
    bufp->fullIData(oldp+1,(vlSelfRef.CpuTop__DOT__rs1_data),32);
    bufp->fullIData(oldp+2,(vlSelfRef.CpuTop__DOT__casez_tmp_0),32);
    bufp->fullIData(oldp+3,(vlSelfRef.CpuTop__DOT__rs2_data),32);
    ...
    bufp->fullIData(oldp+22,(vlSelfRef.CpuTop__DOT__regs_16),32);
    bufp->fullIData(oldp+23,(vlSelfRef.CpuTop__DOT__regs_17),32);
    bufp->fullIData(oldp+24,(vlSelfRef.CpuTop__DOT__regs_18),32);
    bufp->fullIData(oldp+25,(vlSelfRef.CpuTop__DOT__regs_19),32);
    bufp->fullIData(oldp+26,(vlSelfRef.CpuTop__DOT__regs_20),32);
    bufp->fullIData(oldp+27,(vlSelfRef.CpuTop__DOT__regs_21),32);
    bufp->fullIData(oldp+28,(vlSelfRef.CpuTop__DOT__regs_22),32);
    bufp->fullIData(oldp+29,(vlSelfRef.CpuTop__DOT__regs_23),32);
    bufp->fullIData(oldp+30,(vlSelfRef.CpuTop__DOT__regs_24),32);
    bufp->fullIData(oldp+31,(vlSelfRef.CpuTop__DOT__regs_25),32);
    bufp->fullIData(oldp+32,(vlSelfRef.CpuTop__DOT__regs_26),32);
    bufp->fullIData(oldp+33,(vlSelfRef.CpuTop__DOT__regs_27),32);
    bufp->fullIData(oldp+34,(vlSelfRef.CpuTop__DOT__regs_28),32);
    bufp->fullIData(oldp+35,(vlSelfRef.CpuTop__DOT__regs_29),32);
    bufp->fullIData(oldp+36,(vlSelfRef.CpuTop__DOT__regs_30),32);
    bufp->fullIData(oldp+37,(vlSelfRef.CpuTop__DOT__regs_31),32);
    bufp->fullBit(oldp+38,(vlSelfRef.CpuTop__DOT__illegal_seen));
    bufp->fullBit(oldp+39,(vlSelfRef.clock));
    bufp->fullBit(oldp+40,(vlSelfRef.reset));
    bufp->fullIData(oldp+41,(vlSelfRef.io_inst),32);
    bufp->fullIData(oldp+42,(vlSelfRef.io_pc),32);
    bufp->fullIData(oldp+43,(vlSelfRef.io_mem_rdata),32);
    bufp->fullIData(oldp+44,(vlSelfRef.io_mem_addr),32);
    bufp->fullIData(oldp+45,(vlSelfRef.io_mem_wdata),32);
    bufp->fullCData(oldp+46,(vlSelfRef.io_mem_wmask),4);
    bufp->fullBit(oldp+47,(vlSelfRef.io_mem_wen));
    bufp->fullBit(oldp+48,(vlSelfRef.io_mem_ren));
    bufp->fullIData(oldp+49,(vlSelfRef.CpuTop__DOT__immI),32);
}
