...
VL_ATTR_COLD void VCpuTop___024root__trace_init_sub__TOP__0(VCpuTop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBus(c+45,0,"io_mem_rdata",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+46,0,"io_mem_addr",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+47,0,"io_mem_wdata",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+48,0,"io_mem_wmask",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBit(c+49,0,"io_mem_wen",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+50,0,"io_mem_ren",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
    ...
    tracep->declBus(c+5,0,"byte_1",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBus(c+6,0,"wb_data",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->popPrefix();
}
...
VL_ATTR_COLD void VCpuTop___024root__trace_full_0_sub_0(VCpuTop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+5,(vlSelfRef.CpuTop__DOT__byte_1),16);
    bufp->fullIData(oldp+6,(vlSelfRef.CpuTop__DOT__wb_data),32);
    ...
    bufp->fullIData(oldp+24,(vlSelfRef.CpuTop__DOT__regs_16),32);
    bufp->fullIData(oldp+25,(vlSelfRef.CpuTop__DOT__regs_17),32);
    bufp->fullIData(oldp+26,(vlSelfRef.CpuTop__DOT__regs_18),32);
    bufp->fullIData(oldp+27,(vlSelfRef.CpuTop__DOT__regs_19),32);
    bufp->fullIData(oldp+28,(vlSelfRef.CpuTop__DOT__regs_20),32);
    bufp->fullIData(oldp+29,(vlSelfRef.CpuTop__DOT__regs_21),32);
    bufp->fullIData(oldp+30,(vlSelfRef.CpuTop__DOT__regs_22),32);
    bufp->fullIData(oldp+31,(vlSelfRef.CpuTop__DOT__regs_23),32);
    bufp->fullIData(oldp+32,(vlSelfRef.CpuTop__DOT__regs_24),32);
    bufp->fullIData(oldp+33,(vlSelfRef.CpuTop__DOT__regs_25),32);
    bufp->fullIData(oldp+34,(vlSelfRef.CpuTop__DOT__regs_26),32);
    bufp->fullIData(oldp+35,(vlSelfRef.CpuTop__DOT__regs_27),32);
    bufp->fullIData(oldp+36,(vlSelfRef.CpuTop__DOT__regs_28),32);
    bufp->fullIData(oldp+37,(vlSelfRef.CpuTop__DOT__regs_29),32);
    bufp->fullIData(oldp+38,(vlSelfRef.CpuTop__DOT__regs_30),32);
    bufp->fullIData(oldp+39,(vlSelfRef.CpuTop__DOT__regs_31),32);
    bufp->fullBit(oldp+40,(vlSelfRef.CpuTop__DOT__illegal_seen));
    bufp->fullBit(oldp+41,(vlSelfRef.clock));
    bufp->fullBit(oldp+42,(vlSelfRef.reset));
    bufp->fullIData(oldp+43,(vlSelfRef.io_inst),32);
    bufp->fullIData(oldp+44,(vlSelfRef.io_pc),32);
    bufp->fullIData(oldp+45,(vlSelfRef.io_mem_rdata),32);
    bufp->fullIData(oldp+46,(vlSelfRef.io_mem_addr),32);
    bufp->fullIData(oldp+47,(vlSelfRef.io_mem_wdata),32);
    bufp->fullCData(oldp+48,(vlSelfRef.io_mem_wmask),4);
    bufp->fullBit(oldp+49,(vlSelfRef.io_mem_wen));
    bufp->fullBit(oldp+50,(vlSelfRef.io_mem_ren));
    bufp->fullIData(oldp+51,(vlSelfRef.CpuTop__DOT__immI),32);
}
