...
VL_ATTR_COLD void VCpuTop___024root__trace_init_sub__TOP__0(VCpuTop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBus(c+94,0,"io_exception_cause",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
...
VL_ATTR_COLD void VCpuTop___024root__trace_full_0_sub_0(VCpuTop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+94,(((1U & ((~ (IData)(vlSelfRef.CpuTop__DOT___GEN_30)) 
                                     | (IData)(vlSelfRef.CpuTop__DOT___GEN_32)))
                               ? 0U : ((1U == (0x0000000fU 
                                               & (vlSelfRef.io_inst 
                                                  >> 0x00000014U)))
                                        ? 3U : ((0U 
                                                 ...
                                                 ? 0U
                                                 : 0x0bU)))),4);
    bufp->fullBit(oldp+95,(((~ (IData)(vlSelfRef.CpuTop__DOT___GEN_32)) 
