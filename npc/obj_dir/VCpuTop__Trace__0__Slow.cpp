...
VL_ATTR_COLD void VCpuTop___024root__trace_init_sub__TOP__0(VCpuTop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBus(c+35,0,"immI",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
                               ...
                               : ((0x00400000U & vlSelfRef.io_inst)
                                   ...
                                   : ((0x00200000U 
                                       ...
                                       : ((0x00100000U 
                                           ...
                                           ? vlSelfRef.CpuTop__DOT__regs_1
                                           : vlSelfRef.CpuTop__DOT__regs_0))))),32);
    bufp->fullIData(oldp+35,(vlSelfRef.CpuTop__DOT__immI),32);
}
