...
VL_ATTR_COLD void VCpuTop___024root__trace_init_sub__TOP__0(VCpuTop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBus(c+50,0,"io_inst",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+51,0,"io_pc",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+93,0,"immU",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+94,0,"csr_io_mret",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+40,0,"illegal_seen",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+14,0,"byte_1",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBus(c+15,0,"wb_data",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->pushPrefix("alu", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBus(c+16,0,"io_a",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+17,0,"io_b",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+18,0,"io_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->popPrefix();
    ...
    tracep->declBus(c+20,0,"io_csr_rdata",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+41,0,"io_mtvec_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+95,0,"io_exception_cause",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+21,0,"io_exception_pc",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+20,0,"old_value",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
...
VL_ATTR_COLD void VCpuTop___024root__trace_full_0_sub_0(VCpuTop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+13,(vlSelfRef.CpuTop__DOT__next_pc),32);
    bufp->fullSData(oldp+14,(vlSelfRef.CpuTop__DOT__byte_1),16);
    bufp->fullIData(oldp+15,(vlSelfRef.CpuTop__DOT__wb_data),32);
    bufp->fullIData(oldp+16,(vlSelfRef.CpuTop__DOT__alu__DOT__io_a),32);
    bufp->fullIData(oldp+17,(vlSelfRef.CpuTop__DOT__alu__DOT__io_b),32);
    bufp->fullIData(oldp+18,(vlSelfRef.CpuTop__DOT__alu__DOT__io_out),32);
    bufp->fullIData(oldp+19,(vlSelfRef.CpuTop__DOT__csr__DOT__io_rs1_data),32);
    bufp->fullIData(oldp+20,(vlSelfRef.CpuTop__DOT__csr__DOT__io_csr_rdata),32);
    bufp->fullIData(oldp+21,(((1U & ((~ (IData)(vlSelfRef.CpuTop__DOT____VdfgRegularize_h9f7eeac2_0_12)) 
                                     | (IData)(vlSelfRef.CpuTop__DOT___GEN_32)))
                               ? 0U : vlSelfRef.CpuTop__DOT__pc)),32);
    bufp->fullIData(oldp+22,(vlSelfRef.CpuTop__DOT__csr__DOT__casez_tmp),32);
    bufp->fullIData(oldp+23,(vlSelfRef.CpuTop__DOT__pc),32);
    bufp->fullIData(oldp+24,(vlSelfRef.CpuTop__DOT__regs_0),32);
    bufp->fullIData(oldp+25,(vlSelfRef.CpuTop__DOT__regs_1),32);
    bufp->fullIData(oldp+26,(vlSelfRef.CpuTop__DOT__regs_2),32);
    bufp->fullIData(oldp+27,(vlSelfRef.CpuTop__DOT__regs_3),32);
    bufp->fullIData(oldp+28,(vlSelfRef.CpuTop__DOT__regs_4),32);
    bufp->fullIData(oldp+29,(vlSelfRef.CpuTop__DOT__regs_5),32);
    bufp->fullIData(oldp+30,(vlSelfRef.CpuTop__DOT__regs_6),32);
    bufp->fullIData(oldp+31,(vlSelfRef.CpuTop__DOT__regs_7),32);
    bufp->fullIData(oldp+32,(vlSelfRef.CpuTop__DOT__regs_8),32);
    bufp->fullIData(oldp+33,(vlSelfRef.CpuTop__DOT__regs_9),32);
    bufp->fullIData(oldp+34,(vlSelfRef.CpuTop__DOT__regs_10),32);
    bufp->fullIData(oldp+35,(vlSelfRef.CpuTop__DOT__regs_11),32);
    bufp->fullIData(oldp+36,(vlSelfRef.CpuTop__DOT__regs_12),32);
    bufp->fullIData(oldp+37,(vlSelfRef.CpuTop__DOT__regs_13),32);
    bufp->fullIData(oldp+38,(vlSelfRef.CpuTop__DOT__regs_14),32);
    bufp->fullIData(oldp+39,(vlSelfRef.CpuTop__DOT__regs_15),32);
    bufp->fullBit(oldp+40,(vlSelfRef.CpuTop__DOT__illegal_seen));
    bufp->fullIData(oldp+41,(vlSelfRef.CpuTop__DOT__csr__DOT__mtvec),32);
    ...
    bufp->fullIData(oldp+50,(vlSelfRef.io_inst),32);
    bufp->fullIData(oldp+51,(vlSelfRef.io_pc),32);
    ...
    bufp->fullIData(oldp+93,((0xfffff000U & vlSelfRef.io_inst)),32);
    bufp->fullBit(oldp+94,(((~ (IData)(vlSelfRef.CpuTop__DOT___GEN_32)) 
                            & ((IData)(vlSelfRef.CpuTop__DOT___GEN_34) 
                               & (0x18U == (vlSelfRef.io_inst 
                                            >> 0x00000019U))))));
    bufp->fullCData(oldp+95,(((1U & ((~ (IData)(vlSelfRef.CpuTop__DOT___GEN_30)) 
                                     | (IData)(vlSelfRef.CpuTop__DOT___GEN_32)))
                               ? 0U : ((1U == (0x0000000fU 
                                               & (vlSelfRef.io_inst 
                                                  >> 0x00000014U)))
